...
export default function AdminSubmissionsPage() {
  ...
  const load = (status?: string) => {
    setLoading(true);
    adminApi.getSubmissions(status ? { status } : {})
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-0.5">Tất cả bài tập học viên đã nộp</p>
      </div>
                  ...
                  {reviewForm[sub.id] ? (
                    <div className="space-y-3 pt-2 border-t border-gray-200">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => handleReview(sub)} className="btn-primary text-xs py-2 px-5">
                          Lưu
                        </button>
                        <button
