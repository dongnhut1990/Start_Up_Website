...
import { Eye, EyeOff, Plus, BookOpen, Users, Pencil } from "lucide-react";
import { adminApi } from "@/lib/api";
import { Course } from "@/types";
import { formatPrice, COURSE_LEVELS, LEVEL_COLORS, cn } from "@/lib/utils";
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-gray-900">Quản lý khoá học</h1>
          <p className="text-gray-500 mt-1">{courses.length} khoá học trong hệ thống</p>
        </div>
        <Link
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-dashed border-gray-200 py-20 text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">Tạo khoá học đầu tiên để bắt đầu</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  ...
                  <th className="text-left px-5 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider hidden lg:table-cell">Học viên</th>
